...
class JBRefreshGifHeader: JBRefreshStateHeader {
    ...
    override var pullingPercent: CGFloat? {
        set(newPullingPercent) {
            ...
            let image = stateImages[JBRefreshState.Idle.hashValue] as? Array<UIImage>
...
//MARK: - 公共方法
extension JBRefreshGifHeader {
    func setImages(_ images: Array<UIImage>, _ duration: TimeInterval, _ state: JBRefreshState) {
    ...
    func setImages(_ images: Array<UIImage>, _ state: JBRefreshState) {
